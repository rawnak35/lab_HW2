...
train_dir = "/home/student/HW2/data_noise_2/train"
...
def train_model(model, criterion, optimizer, scheduler, dataloaders, dataset_sizes, num_epochs=100):
    ...
    for epoch in range(num_epochs):
        true_preds_dict = {}  # 'i':0, 'ii':0, 'iii':0, 'iv':0, 'ix':0, 'v':0, 'vi':0, 'vii':0, 'viii':0, 'x':0}
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    for y_true, y_pred in zip(labels.data, preds):
                        ...
                        if y_pred == y_true:
                            ...
                            if y_true in true_preds_dict.keys():
                                true_preds_dict[y_true] += 1
                            else:
                                true_preds_dict[y_true] = 1
    ...
    print(true_preds_dict)
    with open("y_true_list_noise.pkl", "wb") as f:
        pickle.dump(y_true_list, f)
    with open("y_pred_list_noise.pkl", "wb") as f:
